...
class CustomFavoriteItems extends GetView<FavoriteViewControllerImp> {
  final MyFavoriteModel itemsModel;

  const CustomFavoriteItems({super.key, required this.itemsModel});
